        ...
        characteristic.writeValue((byte)0x01);
          ...
          characteristic.writeValue((byte)0x03);
            ...
            if (digitalRead(A2) == HIGH) {
              ...
              delay(100);
              characteristic.writeValue((byte)0x30);
            ...
            characteristic.writeValue((byte)0x31);
            if (digitalRead(A3) == HIGH) {

              delay(100);
              characteristic.writeValue((byte)0x32);
            ...
            characteristic.writeValue((byte)0x33);
            if (digitalRead(A4) == HIGH) {

              delay(100);
              characteristic.writeValue((byte)0x34);
            ...
            characteristic.writeValue((byte)0x35);
            if (digitalRead(A5) == HIGH) {

              delay(100);
              characteristic.writeValue((byte)0x36);
            ...
            characteristic.writeValue((byte)0x37);
            if (digitalRead(A6) == HIGH) {

              delay(100);
              characteristic.writeValue((byte)0x38);
            ...
            characteristic.writeValue((byte)0x39);
            if (digitalRead(A7) == HIGH) {

              delay(100);
              characteristic.writeValue((byte)0x40);
